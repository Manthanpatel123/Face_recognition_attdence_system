...
# image
        img_left=Image.open(r"images\student-engagement-definition-1024x619-1.jpg")
 ...
 #frame :current cource information
       ...
       #frame : class student information
        ...
        # entry for gender
        gender_combo = ttk.Combobox(class_stud_frame, textvariable=self.var_gender,font=("times new roman", 11, "bold"), width=23, state="readonly")
...
#button frame1
        btn1_frame = Frame(class_stud_frame, bd=2, relief=RIDGE, bg="white")
        btn1_frame.place(x=5, y=215, width=720, height=35)


        #take photo sample
        takepic_btn = Button(btn1_frame,command=self.generate_dataset, text="Take Photo Sample", width=39 , font=("times new roman", 12, "bold"), bg="orange",fg="black")
        takepic_btn.grid(row=0, column=0)

        # update photo sample
        updpic_btn = Button(btn1_frame, text="Update Photo Sample", width=39, font=("times new roman", 12, "bold"),bg="orange",fg="black")
        ...
        #image
        img_right = Image.open(r"images\facebook.jpg")
       ...
       #combobox for label
        ...
        search_btn = Button(search_frame, text="Search", width=16, font=("times new roman", 12, "bold"), bg="orange",fg="black")
        search_btn.grid(row=0, column=3,padx=4)

        showall_btn = Button(search_frame, text="Show All", width=16, font=("times new roman", 12, "bold"), bg="orange",fg="black")
