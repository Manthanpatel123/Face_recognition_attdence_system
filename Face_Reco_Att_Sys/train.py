...
class Train:
    def __init__(self,root):
      ...
      # main title
        title_lbl = Label(self.root, text="Train Data Set", font=("times new roman", 30, "bold"),bg="white", fg="navy")
        title_lbl.place(x=0, y=0, width=1536, height=45)

      #image1
        img_top = Image.open(r"images\ML.jpg")
        ...
        # button
        b_1 = Button(self.root, text="Train Data",command=self.train_classifier,cursor="hand2",font=("times new roman", 20, "bold"), bg="aqua", fg="navy")
        b_1.place(x=0, y=418, width=1536, height=32)


      #image2
        img_down = Image.open(r"images\image2.jpg")
