...
class Developer:
    def __init__(self,root):
        ...
        # main title
        title_lbl = Label(self.root, text="DEVELOPER", font=("times new roman", 30, "bold"),bg="white", fg="navy")
        ...
        #developer info
        dev_label8 = Label(main_frame,text="front end and back kjslahdksjdoqmkvfkkfkfkfkfkfkfkfkfkkkpppppkkkkkkkkkkkkkkkkk;ncnlfhaslfalkksjdkskkkskskkskskskskskskskskqoks;ljhdhkwdjq;ok;q end developer for python",font=("times new roman", 5, "bold"), bg="black")
        ...
        dev_label3 = Label(main_frame, text="- front end and back end developer for python",font=("times new roman", 15, "bold"), bg="white")
        ...
        dev_label5 = Label(main_frame, text="- front end and back end developer for python",font=("times new roman", 15, "bold"), bg="white")
        ...
        dev_label7 = Label(main_frame, text="- front end and back end developer for python",font=("times new roman", 15, "bold"), bg="white")
