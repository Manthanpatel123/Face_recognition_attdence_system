...
#variables
        ...
        # main title
        title_lbl = Label(bg_img, text="Attendance Management System", font=("times new roman", 30, "bold"),bg="white", fg="navy")
 ...
 #labels and entry
        ...
        # innear label :name
        studentname_label = Label(left_inside_frame, text="Student_Name :", font=("times new roman", 11, "bold"),bg="white")
        ...
        studentdep_label = Label(left_inside_frame, text="Department :", font=("times new roman", 11, "bold"),bg="white")
        ...
        # innear label :sem
        studentsem_label = Label(left_inside_frame, text="Sem :", font=("times new roman", 11, "bold"),bg="white")
        ...
        attendance_label = Label(left_inside_frame, text="Attendance :", font=("times new roman", 11, "bold"),bg="white")
        attendance_label.grid(row=3, column=0, padx=15, sticky=W)
        # entry for attendance
        attendance_combo = ttk.Combobox(left_inside_frame,font=("times new roman", 11, "bold"), width=23, textvariable=self.var_attendance,state="readonly")
        ...
        # importcsv button
        importcsv_btn = Button(btn_frame, text="Import_CSV", command=self.importCsv,width=26, font=("times new roman", 12, "bold"),bg="orange", fg="black")
        importcsv_btn.grid(row=0, column=0)

        # exportcsv button
        exportcsv_btn = Button(btn_frame, text="Export_CSV",command=self.exportCsv, width=26,font=("times new roman", 12, "bold"), bg="orange", fg="black")
        exportcsv_btn.grid(row=0, column=1)

       # reset button
        reset_btn = Button(btn_frame, text="Reset", width=26,command=self.reset_data,font=("times new roman", 12, "bold"), bg="orange", fg="black")
        reset_btn.grid(row=0, column=3)


        # right label frame
        right_inside_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE, text="Attendance Details",font=("times new roman", 12, "bold"))
