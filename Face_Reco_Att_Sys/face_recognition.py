...
class Face_Recognition:
    def __init__(self,root):
        ...
        self.root.title("Face Recognition System")
         #main label
        title_lbl = Label(self.root, text="Face Recognition", font=("times new roman", 30, "bold"),bg="white", fg="navy")
        ...
        f_lbl.place(x=0, y=48, width=1536, height=753)
         #button
        b_11 = Button(f_lbl, text="Face Recognition",cursor="hand2",command=self.face_recog,font=("times new roman", 15, "bold"), bg="black", fg="white")
        b_11.place(x=719, y=350, width=180, height=32)

#============================attendance=======================
    def mark_attendance(self,i1,n1,d1,s1):
        with open("patel.csv","r+",newline="\n") as f:
